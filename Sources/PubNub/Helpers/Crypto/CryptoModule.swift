...
public struct CryptoModule {
  ...
  public func encrypt(data: Data) -> Result<Data, PubNubError> {
    PubNub.log.debug("Will encrypt Data")
    let encryptionResult = performDataEncryption(data: data)
    PubNub.log.debug("Did finish encrypting Data")
  ...
  public func decrypt(data: Data) -> Result<Data, PubNubError> {
    PubNub.log.debug("Will decrypt Data")
    let decryptionResult = performDataDecryption(data: data)
    PubNub.log.debug("Did finish decrypting Data")
  ...
  public func encrypt(stream: InputStream, contentLength: Int) -> Result<InputStream, PubNubError> {
    PubNub.log.debug("Will encrypt InputStream")
    let streamEncryptionResult = performStreamEncryption(stream: stream, contentLength: contentLength)
    PubNub.log.debug("Did finish encrypting InputStream")
  ...
  public func decrypt(
    ...
    PubNub.log.debug("Will decrypt InputStream")
    let streamDecryptionResult = performStreamDecryption(stream: stream, contentLength: contentLength, to: outputPath)
    PubNub.log.debug("Did finish decrypting InputStream")
...
extension CryptoModule {
  func encrypt(string: String) -> Result<Base64EncodedString, PubNubError> {
    ...
    PubNub.log.debug("Did finish encrypting String")
    return encryptionResult
  }

  func decryptedString(from data: Data) -> Result<String, PubNubError> {
    PubNub.log.debug("Will decrypt String from Data")
