...
PubNub Native Swift SDK v10.0.0 is the latest major release of the PubNub SDK for iOS, tvOS, macOS, watchOS and visionOS written in Swift. As a major release, following [Semantic Versioning](https://semver.org/) conventions, v10.0.0 introduces API-breaking changes.

This guide is meant to ease the transition to the 10.0.0 version of the SDK. To read the full set of documentation, please head over to our official [docs page](https://www.pubnub.com/docs/swift-native/pubnub-swift-sdk)
...
```swift
// Before (9.0.0):
func send(message: @escaping @autoclosure () -> String, withType level: LogLevel, withCategory category: LogCategory)
...
// Now (10.0.0) - attach logger via constructor:
